...
test('세 장을 뽑은 뒤 팀 작업 방식 홈으로 이동할 수 있다', async () => {
  ...
  assert.match(styles, /\.home-detail-grid \{[\s\S]*?grid-template-columns: minmax\(0, \.86fr\) minmax\(0, 1\.14fr\);/);
});
